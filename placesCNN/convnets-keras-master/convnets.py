...
def preprocess_img_batch(image_paths, img_size=None, crop_size=None, color_mode="rgb", out=None):
    img_list = []
...
im = preprocess_img_batch(['examples/dog.jpg'],color_mode="bgr")

# Test pretrained model
sgd = SGD(lr=0.1, decay=1e-6, momentum=0.9, nesterov=True)
model, output_dict = convnet('alexnet',weights_path="alexnet_weights.h5", heatmap=False)
print output_dict
